...
{
    /// <summary>얼음 탄환: 슈팅에 맞은 적에게 확률적으로 Freeze 속성을 부여한다.</summary>
    public sealed class IceBulletEffect : ItemEffect
    {
        private readonly float chance;
        /// <summary>Catalog에서 0~100의 발동 확률을 지정한다.</summary>
        public IceBulletEffect(float chance) => this.chance = Mathf.Clamp(chance, 0, 100);
